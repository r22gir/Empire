...
## GOTCHAS
`~/empire-repo` is the MAIN WORKTREE — it owns the shared object store and still receives data writes under backend/data/ (any framing of it as a "stale fork" is wrong) · Cloudflare
