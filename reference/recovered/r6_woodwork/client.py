...
def c1():
    ...
    y=qa(o,y,"4","Baseboard, and will the doors open?",
      ...
      ["Blum\u2019s CLIP top specification governs a minimum reveal measured in millimetres, not",
       "inches, so no side gap is required for the doors to open fully."])
...
def c2b():
    o=[]
    o.append(txt(40,108,"DRAPERY ALLOWANCE",9.6,bold=True))
    o.append(txt(40,128,"The 6\u2033 of clear wall requested at the right end of the unit is confirmed and held.",7.4))
    ...
    for i,t in enumerate(["Wall-to-wall width \u2014 to confirm the 126\u2033 unit and 6\u2033 track reserve both fit.",
