...
def sh1():
    ...
    WAL=[("M","Spacer bar",2,'23 \u00d7 2 \u00d7 1 1/2',"8/4"),
         ...
         ("P","Leg mounting block",8,'4 \u00d7 2 \u00d7 1 1/2',"8/4"),
    ...
    for i,t in enumerate(["Panel 1 \u2014 tower back Q (88 1/4 of the 96)","Panel 2 \u2014 tower back Q",
        ...
        "Panel offcut \u2014 both cleats AA, ripped at 45\u00b0 from one 8\u2033 strip"]):
    ...
    for i,t in enumerate(["Ceiling 136\u2033 confirmed by field scan \u2014 21 1/2\u2033 clear above the unit.",
        "Wall-to-wall width \u2014 confirm 126\u2033 + 6\u2033 reserve fits.",
        "COM legs \u2014 confirm finished height OR the sofa\u2019s floor-to-frame, so both bottoms align.",
        "6\u2033 drapery allowance at the right end \u2014 confirmed."]):
