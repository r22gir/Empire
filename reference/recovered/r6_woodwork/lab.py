...
PARTS = [
    ...
    ("M", "PLINTH RAIL FRONT/BACK",      4, '23"',        '2"'),
    ("AB","PLINTH RAIL SIDE",           4, '14 31/32"',  '2"'),
    ("P", "LEG MOUNTING BLOCK",          8, '4"',         '2"'),
    ("Q", "TOWER BACK PANEL",            2, '88 1/4"',    '22 1/16"'),
    ("R", "OVERHEAD TOP / BOTTOM",       2, '78 9/16"',   '6 9/16"'),
    ("S", "OVERHEAD UPRIGHT INNER",      3, '12 3/4"',    '6 9/16"'),
    ("AC","OVERHEAD UPRIGHT END",        2, '13 11/16"',  '6 9/16"'),
    ("AA","FRENCH CLEAT 45 DEG",         2, '80"',        '4"'),
    ("T", "OVERHEAD BACK PER BAY",       4, '19 3/32"',   '12 1/4"'),
    ("U", "EDGING SHELF / CAP",       12, '20"',        '3/4"'),
    ("V", "EDGING SIDE STILE",        4, '88 1/4"',    '3/4"'),
    ("W", "EDGING OVERHEAD TOP/BOT",     2, '78 9/16"',   '3/4"'),
    ("X", "EDGING UPRIGHT INNER",        3, '12 1/4"',    '3/4"'),
    ("AD","EDGING UPRIGHT END",          2, '13 11/16"',  '3/4"'),
    ("Y", "COVE FASCIA TOWER",        12, '20 9/16"',   '3/4"'),
    ("Z", "COVE FASCIA OVERHEAD",      4, '18 3/32"',   '3/4"'),
]
