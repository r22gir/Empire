...
const ALL_DESKS: Desk[] = [
  { id: 'codedesk', name: 'CodeForge', agent: 'Atlas', icon: <Code2 size={16} />, description: 'Code & craft' },
  { id: 'marketdesk', name: 'MarketDesk', agent: 'Atlas', icon: <ShoppingCart size={16} />, description: 'Marketplace' },
  { id: 'marketingdesk', name: 'MarketingDesk', agent: 'Atlas', icon: <MessageSquare size={16} />, description: 'Marketing' },
  { id: 'supportdesk', name: 'SupportDesk', agent: 'Atlas', icon: <Headphones size={16} />, description: 'Support' },
  { id: 'salesdesk', name: 'SalesDesk', agent: 'Atlas', icon: <BarChart3 size={16} />, description: 'Sales' },
  { id: 'financedesk', name: 'FinanceDesk', agent: 'Atlas', icon: <Database size={16} />, description: 'Finance' },
  { id: 'clientsdesk', name: 'ClientsDesk', agent: 'Atlas', icon: <Users size={16} />, description: 'Clients' },
  { id: 'contractorsdesk', name: 'ContractorsDesk', agent: 'Atlas', icon: <Wrench size={16} />, description: 'Contractors' },
  { id: 'itdesk', name: 'ITDesk', agent: 'Atlas', icon: <Bot size={16} />, description: 'IT support' },
  { id: 'websitedesk', name: 'WebsiteDesk', agent: 'Atlas', icon: <Globe size={16} />, description: 'Web' },
  { id: 'legaldesk', name: 'LegalDesk', agent: 'Raven', icon: <Shield size={16} />, description: 'Legal' },
  { id: 'labdesk', name: 'LabDesk', agent: 'Phoenix', icon: <TestTube size={16} />, description: 'Testing/QA' },
  { id: 'innovationdesk', name: 'InnovationDesk', agent: 'Atlas', icon: <Lightbulb size={16} />, description: 'R&D' },
  { id: 'intakedesk', name: 'IntakeDesk', agent: 'Atlas', icon: <UserPlus size={16} />, description: 'Client intake' },
  { id: 'analyticsdesk', name: 'AnalyticsDesk', agent: 'Raven', icon: <BarChart3 size={16} />, description: 'Analytics' },
  { id: 'qualitydesk', name: 'QualityDesk', agent: 'Phoenix', icon: <ClipboardCheck size={16} />, description: 'Quality assurance' },
  { id: 'codedesk2', name: 'CodeForge', agent: 'Atlas', icon: <Code2 size={16} />, description: 'Coding' },
