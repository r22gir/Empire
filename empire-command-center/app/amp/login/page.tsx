...
import { ampLogin } from '../../lib/amp-auth';
import { Flame, Mail, Lock, ArrowRight } from 'lucide-react';

export default function AmpLogin() {
    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #2D2A26, #3d3530)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ width: '100%', maxWidth: 400 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 24, color: '#FFF9F0', margin: '0 0 4px' }}>Bienvenido de Vuelta</h1>
          <p style={{ fontSize: 13, color: '#9B9590' }}>Ingresa a tu cuenta AMP</p>
        </div>
        <form onSubmit={handleSubmit} style={{ background: '#fff', borderRadius: 16, padding: 28, boxShadow: '0 8px 32px rgba(0,0,0,0.2)' }}>
          ...
          <p style={{ textAlign: 'center', fontSize: 13, color: '#9B9590', marginTop: 16 }}>
            ¿No tienes cuenta? <a href="/amp/signup" style={{ color: '#D4A030', fontWeight: 700, textDecoration: 'none' }}>Regístrate gratis</a>
          </p>
        </form>
